package com.example.korea_sleepTech_Test.config;

import com.example.korea_sleepTech_Test.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/api/notices/**"))
                        .hasRole("ADMIN")
